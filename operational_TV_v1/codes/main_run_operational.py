...
#import step3b_gen_tide_TPOX8 as step3b
...
if __name__ == "__main__":
    ...
    step3.gen_tide(now,"inundation_tide_loc_config.json")
    step3.gen_tide(now,"tailored_report_config.json")
    #step3.gen_tide(now,"tailored_test_report_config.json")
    #step3b.gen_tide(now)
    ...
    #step_12.hallsTailoredForecast(now,"tailored_test_report_config.json")
